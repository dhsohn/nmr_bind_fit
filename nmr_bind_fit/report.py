"""HTML report models and rendering for fit results."""
...
def _best_models_map(decision_entries: Sequence[DecisionEntry] | None) -> dict[str, str]:
...
def write_report_html(
    ...
    *,
    ...
    methods_block = _render_methods_block(methods_sections)
